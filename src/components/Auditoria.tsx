...
import { AUDITORIA_CHECKLIST, AUDITORIA_STATS } from "@/lib/data";
        ...
        <div className="grid gap-10 overflow-hidden rounded-[2.5rem] bg-ink p-8 text-white sm:p-12 lg:grid-cols-2 lg:items-center lg:gap-14">
          ...
          >
            ...
            <h2 className="mt-5 font-display text-3xl font-extrabold leading-tight tracking-tight sm:text-4xl">
              Descubre exactamente cuánto estás dejando de ganar
            </h2>
            <p className="mt-4 max-w-lg text-white/70">
              No es una llamada comercial. Es una sesión técnica gratuita donde un experto en
              automatización analiza tu operación real y te muestra — con números — cuánto puedes
              mejorar.
            </p>
            <ul className="mt-6 flex flex-col gap-3">
              {AUDITORIA_CHECKLIST.map((item) => (
            ...
            <p className="mt-3 text-xs text-white/50">
              Plazas limitadas cada semana. Respuesta garantizada en &lt; 24 h.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="mt-4 text-[11px] text-white/40">
              *Promedios observados en clientes reales. Los resultados pueden variar según sector y
              volumen.
            </p>
          </motion.div>
        </div>
